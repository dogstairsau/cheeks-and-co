...
export const services = [
  ...
  },
  {
    slug: 'ai-native',
    title: 'AI Native',
    tag: 'AI where it earns its place.',
    short: 'Faster production, sharper thinking',
    icon: '/icons/ai-native.svg',
    summary:
      'We use AI across research, production and reporting where it genuinely sharpens the work — and leave it out where it doesn’t.',
    body: [
      `Being AI native doesn't mean running everything through a model. It means knowing which parts of the work AI genuinely improves — research synthesis, audience analysis, creative variations, reporting — and which parts still need someone who understands your business.`,
      `In practice: more creative options tested in less time, faster turnaround on production, and reporting that explains what happened rather than just what was spent. The strategy stays human. The grunt work doesn't have to be.`,
    ],
    includes: [
